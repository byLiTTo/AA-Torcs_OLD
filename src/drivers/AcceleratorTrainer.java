...
public class AcceleratorTrainer extends Controller {
...
//                System.out.println("getAccel: " + DrivingInstructor.getAccel(this.currentSensorModel));
//                System.out.println("filterABS: " + DrivingInstructor.filterABS(this.currentSensorModel, Math.abs(DrivingInstructor.getAccel(this.currentSensorModel))));
//                System.out.println("Accel: " + accel_brake[0]);
//                System.out.println("Brake: " + accel_brake[1]);
//                System.out.println("Reward: " + this.lastAccelReward);
...
//                    this.currentAccelState = AccelControlVariables.evaluateAccelState(sensorModel);
//                    this.lastAccelReward = AccelControlVariables.calculateReward(this.lastSensorModel, this.currentSensorModel);
//                    AccelControlVariables.Actions aux = (AccelControlVariables.Actions) this.accelControlSystem.Update(
//                            this.lastAccelState,
//                            this.currentAccelState,
//                            this.accelActionPerformed,
//                            this.lastAccelReward
