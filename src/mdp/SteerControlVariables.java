...
public class SteerControlVariables {
    ...
    public static final String STEER_Q_TABLE_PATH = "mdp/resources/steerQTable.csv";
    public static final String STEER_STATISTICS_PATH = "mdp/resources/steerStatistics.csv";
